...
#define TIMER_DIV12_VALUE_100us			(65536-130)	    //130*12/16000000 = 100 uS,  		// Timer divider = 12 
#define TIMER_DIV12_VALUE_1ms			(65536-1333)	//1334*12/16000000 = 1 mS, 			// Timer divider = 12 
#define TIMER_DIV12_VALUE_10ms			(65536-13333)	//13333*12/16000000 = 10 mS 		// Timer divider = 12 
...
#define TIMER_DIV12_VALUE_10us			(65536-12)	    //14*12/16600000 = 10 uS,  			// Timer divider = 12 for TM0/TM1
#define TIMER_DIV12_VALUE_100us			(65536-137)	    //138*12/16600000 = 100 uS,  		// Timer divider = 12 
...
#define TIMER_DIV4_VALUE_10us			(65536-42)	    //42*4/16600000 = 10 uS,    		// Timer divider = 4	for TM2/TM3
...
//-------------------- Uart0 function define --------------------
#define		UART0_MODE0_ENABLE		SCON&=0x20
#define		UART0_MODE1_ENABLE		SCON&=0x40;
#define		UART0_MODE2_ENABLE		SCON&=0x80;
#define		UART0_MODE3_ENABLE		SCON&=0xC0;
//-------------------- Uart1 function define --------------------
#define		UART1_MODE0_ENABLE		SCON_1&=0x20
#define		UART1_MODE1_ENABLE		SCON_1&=0x40;
#define		UART1_MODE2_ENABLE		SCON_1&=0x80;
#define		UART1_MODE3_ENABLE		SCON_1&=0xC0;
#endif
