...
#define set_PD      PCON    |= SET_BIT1//掉电模式
#define set_IDL    	PCON    |= SET_BIT0//空闲模式
...
#define set_T0M     CKCON   |= SET_BIT3     //定时器0的时钟选择为系统时钟
#define set_CLOEN   CKCON   |= SET_BIT1

#define clr_PWMCKS  CKCON   &= ~SET_BIT6
#define clr_T1M     CKCON   &= ~SET_BIT4
#define clr_T0M     CKCON   &= ~SET_BIT3    //定时器0的时钟选择为1/12系统时钟
